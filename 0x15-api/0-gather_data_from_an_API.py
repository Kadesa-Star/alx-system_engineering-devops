...
The script uses the JSONPlaceholder API to retrieve employee and TODO data,
then outputs the number of completed tasks and
their titles in the correct format.
"""
